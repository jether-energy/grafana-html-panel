...
System.register(['app/plugins/sdk', 'jquery', 'lodash', 'app/core/utils/kbn', 'app/core/time_series', 'moment', './css/html-panel.css!'], function (_export, _context) {
  "use strict";

  var MetricsPanelCtrl, $, _, kbn, TimeSeries, moment, _createClass, panelDefaults, HtmlCtrl;
  ...
  return {
    ...
    execute: function () {
      ...
      _export('HtmlCtrl', HtmlCtrl = function (_MetricsPanelCtrl) {
        ...
        function HtmlCtrl($scope, $injector, templateSrv, $sce, $http) {
